...
const QUOTES_FS = [
  { num: 1, html: "Oye, if you want to <strong>bring value</strong>:<br>• Prove it.&nbsp; • Document it.&nbsp; • Show the receipts.", tags: ["The Bag", "Execution"] },
  { num: 2, html: "If you’re trying to vibe with everyone, you’re <strong>nobody to anyone</strong>, bro.<br>Pick a lane. Own your block.", tags: ["Identity", "Focus"] },
  { num: 3, html: "<strong>Copywriting</strong> is just knowing how to talk that talk so people actually hit the 'buy' button.", tags: ["Skills", "Hustle"] },
  { num: 4, html: "Focus on the <strong>monthly cash flow</strong>, not just the balance.<br>Reinvest that bread so the bag keeps getting heavier.", tags: ["Money", "Mindset"] },
  { num: 5, html: "The basics are the whole game:<br><strong>Show up.</strong> Stay consistent. Get real skills before you try to flex the big moves.", tags: ["Discipline", "Consistency"] },
  { num: 6, html: "Taking an L isn't starting over.<br>It’s just <strong>leveled-up XP</strong> for the next round.", tags: ["Resilience", "Growth"] },
  { num: 7, html: "The fix in two lines:<br>• Own your mess-up.<br>• <strong>Use what’s in the trunk</strong> and keep driving.", tags: ["Accountability", "Action"] },
  { num: 8, html: "The 'Normal' Phase:<br>Grind <strong>6 days a week, 12 hours a day</strong>.<br>You got the juice now — use it before you lose it.", tags: ["Work Ethic", "The Grind"] },
  { num: 9, html: "When the pockets are thin, live <strong>defensive</strong>.<br>Cut the fat so you can bet the whole house on yourself.", tags: ["Finance", "Survival Mode"] },
  { num: 10, html: "If you're broke:<br>• No fancy dinners&nbsp; • No new drip&nbsp; • <strong>Only free</strong> beach hangs", tags: ["Finance", "Discipline"] },
  { num: 11, html: "Be patient with the results.<br>Be psycho with the action.<br><strong>Movement is the only cure for stress.</strong>", tags: ["Mindset", "Action"] },
  { num: 12, html: "Build a <strong>cash reserve</strong> so you can stop playing defense and start taking over the city.", tags: ["Finance", "Strategy"] },
  { num: 13, html: "The golden rule:<br>Start. Learn. Don't fold.<br>The game is won by the <strong>last shark still swimming</strong>.", tags: ["Persistence", "Mindset"] },
  { num: 14, html: "\"Fake it till you make it\" is for losers.<br>The real move: <strong>do the work before you start posting about it.</strong>", tags: ["Integrity", "Work Ethic"] },
  { num: 15, html: "Content alone won't get you the penthouse.<br><strong>The receipts and the story</strong> are what actually close the deal.", tags: ["Marketing", "Trust"] },
  { num: 16, html: "If someone’s in the fast lane ahead of you, <strong>double the hustle</strong> until they’re in your rearview.", tags: ["Competition", "Drive"] },
  { num: 17, html: "Don't play by their rules.<br><strong>Set your own terms.</strong>", tags: ["Independence", "Mindset"] },
  { num: 18, html: "Pick the move that makes the <strong>better story</strong>.<br>Nobody tells stories about being scared, bro.", tags: ["Courage", "Decision-Making"] },
  { num: 19, html: "Complicated <strong>morning routines</strong> are just distractions.<br>More work equals more results. Simple.", tags: ["Productivity", "Focus"] },
  { num: 20, html: "Identity is mostly a lie.<br>What you <strong>do every single day</strong> is who you really are.", tags: ["Identity", "Habits"] },
  { num: 21, html: "Passive income is a fairy tale.<br>Everything costs time.<br>Focus on <strong>making your hourly rate look like a phone number</strong>.", tags: ["Finance", "Clarity"] },
  { num: 22, html: "If you can't buy it <strong>twice</strong>, you can't afford it once.<br>Think in <strong>hours of grind</strong>, not the price tag.", tags: ["Finance", "Discipline"] },
  { num: 23, html: "Check your <strong>bank account before the 'Gram</strong>.<br>What you track is what grows.", tags: ["Habits", "Finance"] },
  { num: 24, html: "Buy <strong>time</strong>, not toys.<br>Delegate anything that costs less than what your time is worth.", tags: ["Leverage", "Time"] },
  { num: 25, html: "Real wealth isn't the condo or the car.<br>It's <strong>the skills in your head</strong>.<br>A shark doesn't need an inheritance to eat.", tags: ["Wealth", "Skills"] },
  { num: 26, html: "Focus is how many times you say <strong>'No.'</strong><br>Success in one real business beats <strong>seven 'side hustles' that don't pay</strong>.", tags: ["Focus", "Strategy"] },
  { num: 27, html: "The real grind starts <strong>exactly when the hype disappears</strong>.", tags: ["Discipline", "Consistency"] },
  { num: 28, html: "Don't just 'follow your passion.'<br>Follow what you're <strong>good at and what people are cutting checks for</strong>.", tags: ["Career", "Clarity"] },
  { num: 29, html: "Don't worry about networking yet.<br>Get elite at your craft.<br>When you're the best, <strong>the city will come to you</strong>.", tags: ["Growth", "Skill-First"] },
  { num: 30, html: "The guy who <strong>shows up every single day</strong> is impossible to beat.", tags: ["Consistency", "Discipline"] },
  { num: 31, html: "Every dream has a bill — <strong>pay it or cancel the order</strong>, but don't complain.<br>The wealthy buy time. <strong>The ambitious invest in skills</strong>. The lazy just scroll and waste the day.", tags: ["Mindset", "Time", "Ambition"] }
];
